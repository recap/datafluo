...
public class UniProtBank2 {
	...
	public String pairSequenceAlignment(String[] sequence) throws Exception {
	...
	private String pairSequenceAlignmentGlobal(String[] sequence) throws Exception {
		if(sequence.length < 2)
			return "Expected Sequence List Size 2 But Got " + Integer.toString(sequence.length)+"\n";
