...
public class OperationNotAuthorisedException extends RuntimeException {
  public OperationNotAuthorisedException(String msg) {
    super(msg);
  }

  public OperationNotAuthorisedException(String msg, Throwable cause) {
    super(msg, cause);
  }
}
