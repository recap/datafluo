...
public class UnknownWorkflowDefinitionException extends Exception {
  public UnknownWorkflowDefinitionException(String msg) {
    super(msg);
  }

  public UnknownWorkflowDefinitionException(String msg, Throwable cause) {
    super(msg, cause);
  }
}
