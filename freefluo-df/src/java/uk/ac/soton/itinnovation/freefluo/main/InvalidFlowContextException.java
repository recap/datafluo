 ...
 * a flow context is invalid
 */
public class InvalidFlowContextException extends Exception {
  public InvalidFlowContextException(String msg) {
    super(msg);
  }

  public InvalidFlowContextException(String msg, Throwable cause) {
    super(msg, cause);
  }
}
