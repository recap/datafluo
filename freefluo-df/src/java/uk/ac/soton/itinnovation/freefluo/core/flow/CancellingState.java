...
public class CancellingState extends FlowState {
  protected CancellingState(String stateString, int state) {
  ...
  /** 
   * Handles a task failure event.  
   * If Paused and Running task sets are empty flow is Cancelled.
   */ 
  ...
  /** 
   * Handles a task cancelled event.  
   * Tasks are cancelled from paused state.
   * If Paused and Running task sets are empty flow is Cancelled.
   *
   */ 
  ...
  /** 
   * Tasks pausing while the flow is in cancelling state need to be handled.
