...
public interface WorkflowParser {
  WorkflowInstance parse(Engine engine, String workflowDefinition) throws ParsingException;
  WorkflowDescription describe(String workflowDefinition) throws ParsingException;
}
