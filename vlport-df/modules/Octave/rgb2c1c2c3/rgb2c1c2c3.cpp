...
class rgb2c1c2c3 : public IModule {
  ...
  public:
    rgb2c1c2c3(){ 
		...
		MAP_TX_PORT(1,c1c2c3);
		//rx_ports[1] = new MessageQueue("input_file");
		//tx_ports[1] = new MessageQueue("c1c2c3");
	    };
    
    virtual ~rgb2c1c2c3() throw() { }
...
void rgb2c1c2c3::stop(){}

void rgb2c1c2c3::init(vector<string>* rParam){}

void rgb2c1c2c3::start()  {

    TimeLag timing;
    timing.start("rgb2c1c2c3");    
...
//	MessageQueue::Message* im1 = rx_ports[1]->Read();
	...
	string newfile(s);
	newfile.insert(s.length()-4,"_c1c2c3"); 
	//*inStream << s;
	...
	const octave_value_list result3 = feval("rgb2c1c2c3",functionArguments,1);
	functionArguments(0)= result3(0);
	functionArguments(1)= newfile.c_str(); 
	//functionArguments(2)= "PNG";
	LOG_PTAG(Info) << "rgb2c1c2c3 ready"; 
...
//	tx_ports[1]->Write(om1);
    ...
    timing.finish("rgb2c1c2c3");

};    
    

REGISTER_MODULE(rgb2c1c2c3);
//end_of_file
